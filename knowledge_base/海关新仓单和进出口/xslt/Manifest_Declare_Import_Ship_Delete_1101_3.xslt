				...
				<content>
					...
					<bills>
						<xsl:for-each select="$var1_Declaration/ns0:Consignment">
							...
							<xsl:variable name="var14_TransportContractDocument" select="ns0:TransportContractDocument"/>
							...
							<bill>
								...
								<bill_no>
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:value-of select="string($var14_TransportContractDocument/ns0:ID)"/>
										</xsl:otherwise>
									</xsl:choose>
								</bill_no>
								<bill_type>
								...
								<xsl:for-each select="$var14_TransportContractDocument/ns0:ChangeReasonCode">
