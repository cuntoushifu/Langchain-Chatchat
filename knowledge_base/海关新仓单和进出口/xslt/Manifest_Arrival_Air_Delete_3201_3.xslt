...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns0="urn:Declaration:datamodel:standard:CN:MT3201:1" exclude-result-prefixes="xs ns0">
	...
	<xsl:template match="/">
		<Manifest>
			<xsl:for-each select="ns0:Manifest">
				...
				<xsl:variable name="var3_resultof_cast" select="string($var1_Head/ns0:MessageType)"/>
				<xsl:variable name="var4_JourneyID" select="$var2_Declaration/ns0:BorderTransportMeans/ns0:JourneyID"/>
				...
				<xsl:variable name="var7_resultof_cast" select="string($var1_Head/ns0:MessageID)"/>
				...
				<xsl:variable name="var10_resultof_cast" select="string($var4_JourneyID)"/>
