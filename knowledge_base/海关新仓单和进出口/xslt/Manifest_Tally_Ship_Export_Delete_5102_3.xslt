...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns0="urn:Declaration:datamodel:standard:CN:MT5102:1" exclude-result-prefixes="xs ns0">
	...
	<xsl:template match="/">
		<Manifest>
			<xsl:for-each select="ns0:Manifest">
				...
				<xsl:variable name="var10_resultof_cast" select="string($var2_Head/ns0:MessageID)"/>
				...
				<content>
					<transport>
						...
						<customs_code>
							<xsl:value-of select="string($var1_Declaration/ns0:DeclarationOfficeID)"/>
						</customs_code>
					...
					<contas>
						<xsl:for-each select="$var1_Declaration/ns0:TransportEquipment">
							<conta>
								<manifest_id>
									<xsl:choose>
										<xsl:when test="string((string($var13_val) = '2')) != 'false'">
