				...
				<content>
					...
					<bills>
						<xsl:for-each select="$var1_Declaration/ns0:Consignment">
							...
							<xsl:variable name="var12_TransportContractDocument" select="ns0:TransportContractDocument"/>
							<xsl:variable name="var13_resultof_exists" select="boolean($var11_AssociatedTransportDocument)"/>
							<bill>
								<manifest_id>
									<xsl:choose>
										<xsl:when test="string((string($var10_val) = '2')) != 'false'">
								...
								<bill_no>
									<xsl:choose>
										...
										<xsl:otherwise>
											<xsl:value-of select="string($var12_TransportContractDocument/ns0:ID)"/>
										</xsl:otherwise>
									</xsl:choose>
								</bill_no>
								<bill_type>
								...
								<xsl:for-each select="$var12_TransportContractDocument/ns0:ChangeReasonCode">
