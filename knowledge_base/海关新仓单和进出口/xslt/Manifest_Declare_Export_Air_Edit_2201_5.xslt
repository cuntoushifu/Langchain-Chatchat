...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns0="urn:Declaration:datamodel:standard:CN:MT2201:1" exclude-result-prefixes="xs ns0">
	...
	<xsl:template match="/">
		<Manifest>
			<xsl:for-each select="ns0:Manifest">
				...
				<xsl:variable name="var6_ID" select="$var3_BorderTransportMeans/ns0:ID"/>
				<xsl:variable name="var7_resultof_substring" select="substring($var4_resultof_cast, number('4'), number('1'))"/>
				<xsl:variable name="var8_JourneyID" select="$var3_BorderTransportMeans/ns0:JourneyID"/>
				<xsl:variable name="var9_resultof_cast" select="string($var2_Head/ns0:ReceiverID)"/>
				...
				<xsl:variable name="var12_val">
					<xsl:choose>
						<xsl:when test="string(($var7_resultof_substring = '1')) != 'false'">
							<xsl:value-of select="'2'"/>
						</xsl:when>
						<xsl:when test="string(($var7_resultof_substring = '2')) != 'false'">
				...
				<xsl:variable name="var14_val" select="(not((string($var13_resultof_equal) != 'false')) or boolean($var6_ID))"/>
				...
				<content>
					<transport>
						...
						<xsl:for-each select="$var3_BorderTransportMeans/ns0:ArrivalDateTime">
							<xsl:variable name="var17_resultof_cast" select="string(.)"/>
							<xsl:variable name="var18_result">
								<xsl:choose>
									<xsl:when test="string(('15' = string-length($var17_resultof_cast))) != 'false'">
										<xsl:value-of select="substring($var17_resultof_cast, '1', '12')"/>
									</xsl:when>
									<xsl:otherwise>
							...
							<xsl:variable name="var19_resultof_substring" select="substring(concat($var18_result, '000000000'), '1', '14')"/>
							<first_port_date>
								<xsl:value-of select="concat(concat(concat(concat(concat(concat(concat(concat(concat(concat(substring(string($var19_resultof_substring), '1', '4'), '-'), substring(string($var19_resultof_substring), '5', '2')), '-'), substring(string($var19_resultof_substring), '7', '2')), 'T'), substring(string($var19_resultof_substring), '9', '2')), ':'), substring(string($var19_resultof_substring), '11', '2')), ':'), substring(string($var19_resultof_substring), '13', '2'))"/>
							</first_port_date>
						</xsl:for-each>
					...
					<bills>
						<xsl:for-each select="$var1_Declaration/ns0:Consignment">
							...
							<xsl:variable name="var21_PreviousCustomsDocument" select="ns0:PreviousCustomsDocument"/>
							<xsl:variable name="var22_ConsignmentPackaging" select="ns0:ConsignmentPackaging"/>
							<xsl:variable name="var23_GoodsReceiptPlace" select="ns0:GoodsReceiptPlace"/>
							<xsl:variable name="var24_UnloadingLocation" select="ns0:UnloadingLocation"/>
							<xsl:variable name="var25_TotalGrossMassMeasure" select="ns0:TotalGrossMassMeasure"/>
							<xsl:variable name="var26_CustomsStatusCode" select="ns0:CustomsStatusCode"/>
							<xsl:variable name="var27_ValueAmount" select="ns0:ValueAmount"/>
							<xsl:variable name="var28_RoutingCountryCode" select="ns0:RoutingCountryCode"/>
							<xsl:variable name="var29_GrossVolumeMeasure" select="ns0:GrossVolumeMeasure"/>
							<xsl:variable name="var30_resultof_exists" select="boolean($var20_AssociatedTransportDocument)"/>
							<xsl:variable name="var31_TransportContractDocument" select="ns0:TransportContractDocument"/>
							<bill>
								<xsl:if test="string((string($var14_val) != 'false')) != 'false'">
									<manifest_id>
										<xsl:choose>
								...
								<bill_no>
									<xsl:choose>
										<xsl:when test="string((string($var30_resultof_exists) != 'false')) != 'false'">
											<xsl:for-each select="$var20_AssociatedTransportDocument">
												<xsl:value-of select="string(ns0:ID)"/>
											</xsl:for-each>
										</xsl:when>
										<xsl:otherwise>
											<xsl:value-of select="string($var31_TransportContractDocument/ns0:ID)"/>
										</xsl:otherwise>
									</xsl:choose>
								</bill_no>
								<bill_type>
								...
								<xsl:if test="string((string($var30_resultof_exists) != 'false')) != 'false'">
									<parent_bill_no>
										<xsl:value-of select="string($var31_TransportContractDocument/ns0:ID)"/>
									</parent_bill_no>
								</xsl:if>
								...
								<xsl:for-each select="$var29_GrossVolumeMeasure">
									<volume>
										<xsl:value-of select="string(number(string(.)))"/>
									</volume>
								</xsl:for-each>
								<xsl:if test="string(boolean($var29_GrossVolumeMeasure)) != 'false'">
									<volume_unit>
										<xsl:choose>
								...
								<xsl:for-each select="$var27_ValueAmount">
									<goods_price>
										<xsl:value-of select="string(number(string(.)))"/>
									</goods_price>
								</xsl:for-each>
								...
								<xsl:for-each select="$var24_UnloadingLocation/ns0:ID">
									<unload_code>
										<xsl:value-of select="string(.)"/>
									</unload_code>
								</xsl:for-each>
								<xsl:for-each select="$var24_UnloadingLocation/ns0:ArrivalDate">
									<xsl:variable name="var35_resultof_cast" select="string(.)"/>
									<xsl:variable name="var36_result">
										<xsl:choose>
											<xsl:when test="string(('15' = string-length($var35_resultof_cast))) != 'false'">
												<xsl:value-of select="substring($var35_resultof_cast, '1', '12')"/>
											</xsl:when>
											<xsl:otherwise>
												<xsl:value-of select="$var35_resultof_cast"/>
											</xsl:otherwise>
										</xsl:choose>
									</xsl:variable>
									<xsl:variable name="var37_resultof_substring" select="substring(concat($var36_result, '000000000'), '1', '14')"/>
									<unload_date>
										<xsl:value-of select="concat(concat(concat(concat(concat(concat(concat(concat(concat(concat(substring(string($var37_resultof_substring), '1', '4'), '-'), substring(string($var37_resultof_substring), '5', '2')), '-'), substring(string($var37_resultof_substring), '7', '2')), 'T'), substring(string($var37_resultof_substring), '9', '2')), ':'), substring(string($var37_resultof_substring), '11', '2')), ':'), substring(string($var37_resultof_substring), '13', '2'))"/>
									</unload_date>
								</xsl:for-each>
								<xsl:for-each select="$var23_GoodsReceiptPlace/ns0:ID">
									<owner_place_code>
										<xsl:value-of select="string(.)"/>
									</owner_place_code>
								</xsl:for-each>
								<xsl:for-each select="$var23_GoodsReceiptPlace/ns0:Name">
									<owner_place_name>
										<xsl:value-of select="string(.)"/>
									</owner_place_name>
								</xsl:for-each>
								...
								<xsl:choose>
									<xsl:when test="string(boolean($var28_RoutingCountryCode)) != 'false'">
										<xsl:for-each select="$var28_RoutingCountryCode[not((string(string-length(substring(concat(string(.), ';'), '1', (string-length(concat(string(.), ';')) - '1')))) = '0'))]">
											<pass_country_code>
								...
								<xsl:for-each select="$var31_TransportContractDocument/ns0:ChangeReasonCode">
									<xsl:variable name="var40_resultof_concat" select="concat(string(.), ';')"/>
									<xsl:variable name="var41_resultof_substring" select="substring($var40_resultof_concat, '1', (string-length($var40_resultof_concat) - '1'))"/>
								...
								<xsl:for-each select="$var31_TransportContractDocument/ns0:ConditionCode">
									<fee_condition>
										<xsl:value-of select="string(.)"/>
									</fee_condition>
								</xsl:for-each>
								...
								<xsl:choose>
									<xsl:when test="string(boolean($var26_CustomsStatusCode)) != 'false'">
										<xsl:for-each select="$var26_CustomsStatusCode[not((string(string-length(substring(concat(string(.), ';'), '1', (string-length(concat(string(.), ';')) - '1')))) = '0'))]">
											<customs_state_code>
												<xsl:value-of select="substring(concat(string(.), ';'), '1', (string-length(concat(string(.), ';')) - '1'))"/>
											</customs_state_code>
										</xsl:for-each>
									...
									<xsl:otherwise>
										<xsl:variable name="var42_resultof_first" select="';'"/>
										<xsl:variable name="var43_resultof_substring" select="substring($var42_resultof_first, '1', (string-length($var42_resultof_first) - '1'))"/>
										<xsl:if test="string(not((string(string-length($var43_resultof_substring)) = '0'))) != 'false'">
											<customs_state_code>
												<xsl:value-of select="$var43_resultof_substring"/>
											</customs_state_code>
										</xsl:if>
									</xsl:otherwise>
								</xsl:choose>
								...
								<xsl:for-each select="$var22_ConsignmentPackaging/ns0:TypeCode">
									<wrap_type>
										<xsl:value-of select="string(.)"/>
									</wrap_type>
								</xsl:for-each>
								<xsl:for-each select="$var22_ConsignmentPackaging/ns0:QuantityQuantity">
									<pack_no>
										<xsl:value-of select="string(number(string(.)))"/>
									</pack_no>
								</xsl:for-each>
								<xsl:for-each select="$var25_TotalGrossMassMeasure">
									<gross_wt>
										<xsl:value-of select="string(number(string(.)))"/>
									</gross_wt>
								</xsl:for-each>
								<xsl:if test="string(boolean($var25_TotalGrossMassMeasure)) != 'false'">
									<weight_unit>KG</weight_unit>
								</xsl:if>
								<xsl:for-each select="$var21_PreviousCustomsDocument">
									<forward_form_id>
										<xsl:value-of select="string(ns0:ID)"/>
									</forward_form_id>
								</xsl:for-each>
								...
								<goods_infos>
									<xsl:for-each select="ns0:ConsignmentItem">
										...
										<xsl:variable name="var148_GoodsMeasure" select="ns0:GoodsMeasure"/>
										<xsl:variable name="var149_UCR" select="ns0:UCR"/>
										<goods_info>
											<xsl:if test="string((string($var14_val) != 'false')) != 'false'">
												<manifest_id>
													<xsl:choose>
											...
											<xsl:for-each select="$var148_GoodsMeasure">
												<gross_wt>
													<xsl:value-of select="string(number(string(ns0:GrossMassMeasure)))"/>
												</gross_wt>
											</xsl:for-each>
											<xsl:if test="string(boolean($var148_GoodsMeasure)) != 'false'">
												<weight_unit>KG</weight_unit>
											</xsl:if>
											...
											<xsl:choose>
												<xsl:when test="string(boolean($var149_UCR)) != 'false'">
													<xsl:for-each select="$var149_UCR[not((string(string-length(substring(concat(string(ns0:ID), ';'), '1', (string-length(concat(string(ns0:ID), ';')) - '1')))) = '0'))]">
														<ucr>
															<xsl:value-of select="substring(concat(string(ns0:ID), ';'), '1', (string-length(concat(string(ns0:ID), ';')) - '1'))"/>
														</ucr>
													</xsl:for-each>
