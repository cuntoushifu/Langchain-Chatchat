...
-->
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:ns0="urn:Declaration:datamodel:standard:CN:MT8102:1" exclude-result-prefixes="xs ns0">
	...
	<xsl:template match="/">
		<Manifest>
			<xsl:for-each select="ns0:Manifest">
				...
				<xsl:variable name="var8_resultof_cast" select="string($var1_Head/ns0:SenderID)"/>
				...
				<xsl:variable name="var11_resultof_cast" select="string($var6_JourneyID)"/>
